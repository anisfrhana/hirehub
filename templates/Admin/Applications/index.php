		...
		?>
            ...
            <tbody>
				...
				<td><?php echo $counter++ ?></td>
					...
					<td>
					<?php 
						if ($application->hasValue('job') && $application->job && !empty($application->job->title)) {
							echo $this->Html->link(h($application->job->title), ['controller' => 'Jobs', 'action' => 'view', $application->job->id]);
						}
						?>
					</td>               
                    <td><?= $application->hasValue('applicant') ? $this->Html->link($application->applicant->fullname, ['controller' => 'Applicants', 'action' => 'view', $application->applicant->id]) : '' ?></td>
	...
	<div class="card-body">
		<div class="card-title mb-0">Search</div>
			...
			<?php echo $this->Form->create(null, ['valueSources' => 'query', 'url' => ['controller' => 'Applications','action' => 'index']]); ?>
				<fieldset>
					<div class="mb-1"><?php echo $this->Form->control('id',['required' => false]); ?>
				...
				<div class="mb-1">
					...
					<div class="mb-1">
						<?php echo $this->Form->control('application_date_to', ['label' => 'Application Date To', 'type' => 'date']); ?>
					</div>
				</div>
