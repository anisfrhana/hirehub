...
<?= h($statusText) ?></td>
                ...
                Kindly be advised that the individual named above is an employee of <?= h($application->company_name) ?>.
                    <br /><br />
                    &nbsp; &nbsp;&nbsp; &nbsp; As part of your employment, you will be expected to fulfill the duties and responsibilities outlined in the job description and will be part of a dynamic team working towards <?= h($application->company_name) ?>. You will also be required to adhere to our company policies, procedures, and work standards.
                    <br /><br />
                    ...
                    <br /><br />
                    We look forward to working with you and are confident that your skills and experience will be a great addition to our team. Welcome aboard!
	  ...
	  <div class="card bg-body-tertiary border-0 shadow rounded-5">
        <div class="card-body">
            ...
            <?php if ($application->status == 1) {
                ...
                echo $this->Html->link(('Download PDF'), ['action'=>'pdf', $application->id, 'prefix' => false], ['class'=>'btn btn-sm btn-outline-primary', 'escapeTitle' =>false] );
                echo $this->Form->button(('Reset'), ['type' => 'reset', 'class' => 'btn btn-outline-warning']); 
                echo $this->Form->button('Update Status');
                echo $this->Form->end();
                ?>
            </div>
