    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <li class="menu-item <?= $c_name == 'Applicants' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-user"></i> Applicant'), ['controller' => 'Applicants', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>

                <li class="menu-item <?= $c_name == 'Jobs' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-folder"></i> Job'), ['controller' => 'Jobs', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>

                <li class="menu-item <?= $c_name == 'Applications' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-inbox"></i> Application'), ['controller' => 'Applications', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Applicant' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-user"></i> Applicants'), ['controller' => 'Applicants', 'action' => 'index', 'prefix' => 'Admin'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                    <li class="menu-item <?= $c_name == 'Jobs' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-folder"></i> Job'), ['controller' => 'Jobs', 'action' => 'index', 'prefix' => 'Admin'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                    <li class="menu-item <?= $c_name == 'Applications' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-inbox"></i> Application<span class="badge text-bg-warning">' . $total_applications_pending . '</span>'), ['controller' => 'Applications', 'action' => 'index', 'prefix' => 'Admin'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
