                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__('<i class="far fa-folder-open"></i>'), ['controller' => 'Applications', 'action' => 'view', $applications->id], ['class' => 'btn btn-outline-primary btn-xs', 'escapeTitle' => false]) ?>
                                <?= $this->Html->link(__('<i class="fa-regular fa-pen-to-square"></i>'), ['controller' => 'Applications', 'action' => 'edit', $applications->id], ['class' => 'btn btn-outline-warning btn-xs', 'escapeTitle' => false]) ?>
